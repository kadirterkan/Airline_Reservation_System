...
public partial class Components_FlightCard : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        departureAirport.Text = Flight.DepartureAirport.AirportName;
        flightDuration.Text = TimeSpan.FromMinutes(Flight.FlightTimeByMinutes).ToString(@"hh mm");
        arrivalTime.Text = Flight.DepartureTime.ToString("HH:MM");
        arrivalAirport.Text = Flight.ArrivalAirport.AirportName;
